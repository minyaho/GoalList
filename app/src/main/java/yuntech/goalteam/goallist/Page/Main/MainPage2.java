...
public class MainPage2 extends Fragment implements SwipeRefreshLayout.OnRefreshListener{
    ...
    private void init(){
        ...
        tv_page_title.setText("Delay");
        tv_empty.setText("There is empty\nNothing is delay");
        iv_empty.setImageResource(R.drawable.ic_timeout_120);
    ...
    public void onRefresh() {   //swipeRefreshLayout的刷新動作
        ...
        System.out.println("Page 2: onRefresh");
    }
    ...
    public void onResume() {    //fragment的復甦動作
        ...
        initDate();
        adapter.notifyDataSetChanged();
        System.out.println("Page 2: onResume");
    }
